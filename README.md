...
*    **2026-08-27 (v1.13.0)** : Performance improvements (thanks @jvoisin), add top-level `Text` function with options similar to BeautifulSoup's `get_text` (thanks @ChrisJr404), update `go.mod` dependencies, add go1.27 to the test matrix.
